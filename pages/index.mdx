...
<details>
  <summary>
    **Why does it take a code-generation approach instead of providing pre-built
    binaries?**
  </summary>
...
<details>
  ...
  compatible with Compose Multiplatform. But it does not look good on desktop and
  web platforms. Full Compose Multiplatform support is planned for future updates.
</details>

...
<Demo componentId="SLIDER" />

<br />

## Installation

Slider uses the slider implementation from the [composables](https://github.com/nomanr/composables/tree/main/composables/src/commonMain/kotlin/com/nomanr/composables/slider) library.
